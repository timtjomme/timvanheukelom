...
var pp_feed_5bf54ba4dafb1;
(function($) {
	var items = '3';
	var items_medium = '3';
	var items_responsive = '3';
	var width = '550';
	var width_medium = '550';
	var width_responsive = '550';
	...
	var layout 			= 'grid',
		...
		carouselOpts		= {
			...
			loop					: false,
			pagination				: {
				el: '.fl-node-5bf54ba4dafb1 .swiper-pagination',
				clickable: true
			},
			navigation				: {
				prevEl: '.fl-node-5bf54ba4dafb1 .swiper-button-prev',
				nextEl: '.fl-node-5bf54ba4dafb1 .swiper-button-next'
			},
			breakpoints: {
				992: {
					slidesPerView:  2,
	...
	pp_feed_5bf54ba4dafb1 = new PPInstagramFeed({
		id: '5bf54ba4dafb1',
		layout: 'grid',
		limit: 100,
		/*
		...
		*/
		...
		isBuilderActive: false,
			...
			$('.fl-node-5bf54ba4dafb1 .pp-instagram-feed').magnificPopup({
...
(function($) {
	...
	var layout 			= 'grid',
		...
		carouselOpts		= {
			...
			loop					: false,
			pagination				: {
				el: '.fl-node-6473087df3e41 .swiper-pagination',
				clickable: true
			},
			navigation				: {
				prevEl: '.fl-node-6473087df3e41 .swiper-button-prev',
				nextEl: '.fl-node-6473087df3e41 .swiper-button-next'
			},
			breakpoints: {
				992: {
					slidesPerView:  2,
	...
	pp_feed_6473087df3e41 = new PPInstagramFeed({
		id: '6473087df3e41',
		layout: 'grid',
		limit: 12,
		/*
