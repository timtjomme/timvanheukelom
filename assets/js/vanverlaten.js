...
(function($) {
	...
	$(function() {
			...
			$('.fl-node-5c975fe9ac191 .fl-mosaicflow-content, .fl-node-5c975fe9ac191 .fl-gallery').magnificPopup({
				...
				$('.fl-node-5c975fe9ac191 .fl-mosaicflow-content').one( 'mosaicflow-filled', function(){
	...
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.fl-node-5c975fe9ac191 .fl-mosaicflow-content').trigger('resize');
		},50);
	});
})(jQuery);
(function($) {
	...
	$(function() {
				...
				if (typeof $.fn.magnificPopup !== 'undefined') {
			$('.fl-node-5c9760fb6e0e9 .fl-mosaicflow-content, .fl-node-5c9760fb6e0e9 .fl-gallery').magnificPopup({
				delegate: '.fl-photo-content > a',
				closeBtnInside: false,
				type: 'image',
				gallery: {
				...
				$('.fl-node-5c9760fb6e0e9 .fl-mosaicflow-content').one( 'mosaicflow-filled', function(){
			var hash = window.location.hash.replace( '#', '' );
			if ( hash != '' ) {
				FLBuilderLayout._scrollToElement( $( '#' + hash ) );
			}
	...
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.fl-node-5c9760fb6e0e9 .fl-mosaicflow-content').trigger('resize');
		},50);
	});
})(jQuery);
jQuery(document).ready(function(){
...
(function($) {
	...
	$(function() {
				...
				if (typeof $.fn.magnificPopup !== 'undefined') {
			$('.fl-node-5c976053f1523 .fl-mosaicflow-content, .fl-node-5c976053f1523 .fl-gallery').magnificPopup({
				delegate: '.fl-photo-content > a',
				closeBtnInside: false,
				type: 'image',
				gallery: {
				...
				$('.fl-node-5c976053f1523 .fl-mosaicflow-content').one( 'mosaicflow-filled', function(){
			var hash = window.location.hash.replace( '#', '' );
			if ( hash != '' ) {
				FLBuilderLayout._scrollToElement( $( '#' + hash ) );
			}
	...
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.fl-node-5c976053f1523 .fl-mosaicflow-content').trigger('resize');
		},50);
	});
})(jQuery);
jQuery(document).ready(function(){
