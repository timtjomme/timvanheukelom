...
(function($) {
	...
	$(function() {
				...
				if (typeof $.fn.magnificPopup !== 'undefined') {
			$('.fl-node-5be6ebf886b84 .fl-mosaicflow-content, .fl-node-5be6ebf886b84 .fl-gallery').magnificPopup({
				delegate: '.fl-photo-content > a',
				closeBtnInside: false,
				type: 'image',
				gallery: {
				...
				$('.fl-node-5be6ebf886b84 .fl-mosaicflow-content').one( 'mosaicflow-filled', function(){
			var hash = window.location.hash.replace( '#', '' );
			if ( hash != '' ) {
				FLBuilderLayout._scrollToElement( $( '#' + hash ) );
			}
	...
	jQuery(document).ready(function(){
		setTimeout(function(){
			jQuery('.fl-node-5be6ebf886b84 .fl-mosaicflow-content').trigger('resize');
		},50);
	});
})(jQuery);
