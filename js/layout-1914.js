...
(function($) {
	...
	$(function() {
		var numModule = window.number_module_5ad661ffbf335;
		...
		new FLBuilderNumber({
			...
			number: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.number : 250 ),
			max: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.max : 250 ),
			speed: 4000,
			delay: 1,
		});
	});
...
(function($) {
	...
	$(function() {
		var numModule = window.number_module_5ad660f0cfc23;
		...
		new FLBuilderNumber({
			...
			type: 'standard',
			start_number: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.start_number : 0 ),
			number: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.number : 87501 ),
			max: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.max : 87501 ),
			speed: 4000,
			delay: 0,
		});
	});
...
(function($) {
	...
	$(function() {
		var numModule = window.number_module_5ad661ef47d80;
		...
		new FLBuilderNumber({
			...
			type: 'standard',
			start_number: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.start_number : 0 ),
			number: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.number : 12 ),
			max: parseFloat( ( 'undefined' !== typeof numModule ) ? numModule.max : 12 ),
			speed: 4000,
			delay: 0,
		});
	});
